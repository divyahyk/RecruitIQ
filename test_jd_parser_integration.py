...
print("\n[2??] Testing JobData instantiation...")
try:
    jd = JobData(
        jd_code="JD001",
...
print("\n[3??] Testing JobData.from_jd_dict() with mixed formats...")
try:
    raw_dict = {
        "jd_code": "JD002",
...
print("\n[6??] Testing JDParser initialization...")
try:
