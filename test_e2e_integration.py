...
print("\n[4??] Parsing JD to JobData object...")
try:
...
print("\n[7??] Validating dict for database storage...")
try:
...
print("\n[8??] Testing round-trip: dict ? JobData ? dict...")
try:
...
print("\n[9??] Testing parse_with_validation()...")
try:
