...
print("\n[3️⃣] Testing skill normalization...")
try:
    test_cases = [
        (["Python", "FastAPI"], "list"),
...
print("\n[6️⃣] Testing JobData.from_jd_dict()...")
try:
    sample_dict = {
        "jd_code": "JD999",
...
print("\n[7️⃣] Testing round-trip: dict → JobData → dict...")
try:
